...
Message: We Didn't Find Any CC In @{channel_link}.
            ...
            file_name = f"downloads/{amt}x_CC_Scraped_For_{message.from_user.id}_By_@Eretro_7.txt"
...
● Bot by - <a href="tg://user?id=6699273462">Retro</a>
"""
...
Message: We Didnt Find Any SK In @{channel_link} .
            ...
            file_name = f"downloads/{amt}x_SK_Scraped_For_{message.from_user.id}_By_@Eretro_7.txt"
            with open(file_name, "a", encoding="UTF-8") as f:
                for x in ccs:
                    f.write(f"{x}\n")
